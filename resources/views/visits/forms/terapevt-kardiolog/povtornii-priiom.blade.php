<div class="card-body">
    <form id="saveForm">
        ...
        <div class="row mb-3">
            <labe for="pop_diagnoz" class="col-md-2 col-form-label">Діагноз</labe>
            <div class="col-md-10">
                <textarea name="diagnoz" class="form-control" rows="3">{!! isset($info) ? nl2br(json_decode($info->value, true)['diagnoz']) : ' ' !!}</textarea>
            </div>
        </div>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            <label for="new_oglyad" class="col-md-2 col-form-label">Повторний огляд рекомендовано: </label>
            <div class="col-md-10">
