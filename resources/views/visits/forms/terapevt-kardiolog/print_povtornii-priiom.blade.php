...
<table width="100%">
    ...
    <tr>
        <td>
            <div class="page-body">
                <div class="title">
                    <h2 class="green">ПОВТОРНА КОНСУЛЬТАЦІЯ ТЕРАПЕВТА</h2>
                </div>
                <div class="patient_info">
                    ...
                    @if(isset($info->value))
                        ...
                        <div class="row" style="padding-bottom: 3px; padding-top: 3px">
                            <span>Діагноз: </span> {!! nl2br(json_decode($info->value, true)['diagnoz']) !!}
                        </div>
                        <div class="row" style="padding-bottom: 3px; padding-top: 3px">
                        ...
                        <div class="row" style="padding-bottom: 3px; padding-top: 3px">
                            <span>Повторний огляд рекомендовано: </span> {{ json_decode($info->value, true)['new_oglyad'] }}
                        </div>
