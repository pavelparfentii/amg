...
<table width="100%">
    ...
    <tr>
        <td>
            <div class="page-body">
                <div class="title">
                    <h2 class="green">Повторна консультація лікаря психіатра</h2>
                </div>
                <div class="patient_info">
                    ...
                    @if(isset($info->value))
                        ...
                        <div class="row" style="padding-bottom: 3px; padding-top: 3px">
                            <span>Ps.St: </span> {{ nl2br(json_decode($info->value, true)['psst']) }}
                        </div>
                        <div class="row" style="padding-bottom: 3px; padding-top: 3px">
                            <span>Попередній діагноз: </span> {{ json_decode($info->value, true)['pop_diagnoz'] }}
                        </div>
                        <div class="row" style="padding-bottom: 3px; padding-top: 3px">
                            <span>Рекомендоване дообстеження: </span> {{ json_decode($info->value, true)['recom_doobst'] }}
                        </div>
                        <div class="row" style="padding-bottom: 3px; padding-top: 3px">
                            <span>Рекомендоване лікування: </span> {{ json_decode($info->value, true)['recomendation'] }}
                        </div>
                    @endif
                    <div class="row" style="padding-bottom: 3px; padding-top: 3px">
