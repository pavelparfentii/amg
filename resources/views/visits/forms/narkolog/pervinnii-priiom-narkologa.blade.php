<div class="card-body">
    <form id="saveForm">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10">
                <textarea name="psst" class="form-control" rows="3">{{ isset($info) ? json_decode($info->value, true)['psst'] : ' ' }}</textarea>
            </div>
        </div>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10">
                <textarea name="recom_doobst" class="form-control" id="recom_doobst" rows="3">{{ isset($info) ? json_decode($info->value, true)['recom_doobst'] : ' ' }}</textarea>
            </div>
        </div>
        <div class="row mb-3">
            <label for="recomendation" class="col-md-2 col-form-label">Рекомендоване лікування</label>
            <div class="col-md-10">
                <textarea name="recomendation" class="form-control" rows="3">{{ isset($info) ? json_decode($info->value, true)['recomendation'] : ' ' }}</textarea>
            </div>
        </div>
