...
<table width="100%">
    ...
    <tr>
        <td>
            <div class="page-body">
                <div class="title">
                    <h2 class="green">ВИСНОВОК ЕНДОКРИНОЛОГА</h2>
                </div>
                <div class="patient_info">
                    ...
                    @if(isset($info->value))
                        <div class="row" style="padding-bottom: 3px; padding-top: 3px">
                            <span>Заключний діагноз: </span> {!! nl2br(json_decode($info->value, true)['zakl_diagnoz']) !!}
                        </div>
                        <div class="row" style="padding-bottom: 3px; padding-top: 3px">
                            <span>Рекомендовано: </span> {!! nl2br(json_decode($info->value, true)['recomendation']) !!}
                        </div>
                    @endif
                    <div class="row" style="padding-bottom: 3px; padding-top: 3px">
