...
<table width="100%">
    ...
    <tr>
        <td>
            <div class="page-body">
                <div class="title">
                    <h2 class="green">ПЕРВИННА КОНСУЛЬТАЦІЯ ЕНДОКРИНОЛОГА</h2>
                </div>
                <div class="patient_info">
                    ...
                    @if(isset($info->value))
                        ...
                        <div class="row" style="padding-bottom: 3px; padding-top: 3px">
                            <span>Анамнез: </span>{{ json_decode($info->value, true)['anamnez'] }}
                        </div>
                        <div class="row" style="padding-bottom: 3px; padding-top: 3px">
                        ...
                        <div class="row" style="padding-bottom: 3px; padding-top: 3px">
                            <span>Висновок: </span> {{ json_decode($info->value, true)['vysnovok'] }}
                        </div>
                        <div class="row" style="padding-bottom: 3px; padding-top: 3px">
